...
then
echo "--------------------------gemma2zoom--------------------------"
echo "Description: Wrapper around PLINK and gemma_zoom_ld.R to output zoomed in manhattan from GEMMA association output."
echo "Dependencies: PLINK, R: Bioconductor, rtracklayer"
echo "Usage: bash gemma2zoom.sh [options]"
echo "OPTIONS:"
...
# set directory of gemma2zoom script
my_dir="$(dirname "$0")"
...
echo "--------------------------gemma2zoom--------------------------"
echo "Description: Wrapper around PLINK and gemma_zoom_ld.R to output zoomed in manhattan from GEMMA association output."
echo "Dependencies: gemma_zoom_ld.R"
echo "Usage: bash gemma2zoom.sh [options]"
echo "---------------------------OPTIONS----------------------------"
